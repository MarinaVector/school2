                                ...
                                <div class="row position-relative">
                                    ...
                                    <div class="col-xl-6 offset-xl-6 col-12 px-3 px-md-0 offset-md-0">
                                        ...
                                        высшее экономическое образование</h4>
                                            ...
                                            <ul class="fa-ul about-author__list mr-lg-n5">
                                                <li class="about-author__block pl-2 my-3"><span class="fa-li about-author__info">
                                                        <img class="arrow" src="/img/arrow_green.png"
                                                             alt="arrow_green"></span>С 1996 по 2009
                                            ...
                                            <p class="about-author__info">Креативный кросс-маркетинг появился в моей
                                                жизни как инструмент помощи в развитии бизнеса для моих клиентов.
                                            </p>

                                            <p class="about-author__info my-1 px-lg-0 py-1">Многолетний опыт работы с
