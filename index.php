                                ...
                                <?php require "general-components/nav.php"; ?>
                                    <div class="info-block container
                                     pb-3 mt-3 mt-md-0 my-lg-5 py-lg-4">
                                        ...
                                        <a class="info-block__btn info-block__full-btn__learn info-block__yellow-btn top-btn mr-xl-5 mb-3 my-xl-5 mr-2">приступить к
                                обучению</a>
                                        <a class="info-block__btn info-block__empty-btn info-block__empty-btn__yellow top-btn
                        ...
                        <div class="container">
                            ...
                            <div class="col-md-12 mt-lg-5">
                                ...
                                <section class="container">
                                    <h3 class="section-product__title faq-clients my-mt-5">Отзывы наших клиентов</h3>
                                    <div class="">
