        ...
        <div class="container">
            <div class="row p-0">
                <div class="col-lg-4 col-12 life-coaching__program">
                    <div class="coach-module my-md-5 p-lg-3 p-2">
                                ...
                                <a class="video__link" href="https://youtu.be/neHA4MJwpnY">
                                    <picture class="video-block">
                                        ...
                                        <img class="video__media"
                                             ...
                                             alt="1 занятие — Как продавать не продавая. План продаж
                                с помощью Диагностики. (Доп. инструмент в подарок)»">
                                    </picture>
                                </a>
                            ...
                            <div class="video">
                                <a class="video__link" href="https://youtu.be/neHA4MJwpnY">
                                    <picture class="video-block">
                                        ...
                                        <img class="video__media"
                                             src="https://i.ytimg.com/vi/JaTKpkQ_9v8/maxresdefault.jpg"
                                             alt="2 занятие — Инструмент «Расширение границ Сознания»
                                (1 часть)">
                                    </picture>
                                </a>
                                <button class="video__button" aria-label="Запустить видео">
                            ...
                            <div class="video">
                                <a class="video__link" href="https://youtu.be/neHA4MJwpnY">
                                    <picture class="video-block">
                                        ...
                                        <img class="video__media"
                                             src="https://i.ytimg.com/vi/JaTKpkQ_9v8/maxresdefault.jpg"
                                             alt="3 занятие — Техника продаж индивидуальных сессий и мастер
                                групп (2 часть)">
                                    </picture>
                                </a>
                                <button class="video__button" aria-label="Запустить видео">
                            ...
                            <div class="video">
                                <a class="video__link" href="https://youtu.be/neHA4MJwpnY">
                                    <picture class="video-block">
                                        ...
                                        <img class="video__media"
                                             src="https://i.ytimg.com/vi/JaTKpkQ_9v8/maxresdefault.jpg"
                                             alt="4 занятие — Как выбрать тему вебинара, составить план
                                вебинара и сделать продажи с открытых вебинаров">
                                    </picture>
                                </a>
                                <button class="video__button" aria-label="Запустить видео">
                                    <svg width="68" height="48" viewBox="0 0 68 48">
                            ...
                            <div class="video">
                                <a class="video__link" href="https://youtu.be/neHA4MJwpnY">
                                    <picture class="video-block">
                                        ...
                                        <img class="video__media"
                                             src="https://i.ytimg.com/vi/JaTKpkQ_9v8/maxresdefault.jpg"
                                             alt="5 занятие — Инструмент «Разборы задач в Отношениях»">
                                    </picture>l
                                </a>
                                <button class="video__button" aria-label="Запустить видео">
                                    <svg width="68" height="48" viewBox="0 0 68 48">
