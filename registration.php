...
<main class="my-5">
    <div class="container auth-form bootdey my-3">
        ...
        <div class="omb_login">
            ...
            <div class="row omb_row-sm-offset-3 omb_socialButtons mb-5">
                ...
                <div class="registration-bg col-xs-12 col-sm-6">
                    <form class="omb_loginForm" action="" autocomplete="off" method="POST">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control stage__stage-txt" name="username" placeholder="Ваше имя">
                        </div>
                        <span class="help-block"></span>
                        <div class="input-group mb-3">
                            <span class="input-group-addon"><i class="fa fa-envelope mr-2"></i></i></span>
                            <input  type="password" class="form-control stage__stage-txt" name="password" placeholder="Ваш @-mail">
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-addon"><i class="fa fa-lock mr-2"></i></span>
                            <input  type="password" class="form-control stage__stage-txt" name="password" placeholder="Повтор пароля">
                        </div>
                        <div class="mx-auto">
