<div class="container-fluid mb-5 mb-lg-0">
    <nav class="nav nav-fill col-lg-10 offset-lg-1 mb-5 mb-lg-0 mt-md-1 pb-lg-3 pl-xl-5">
        <a class="nav-link px-md-0" href="../index.php">
            <img class="main-nav__nav-logo my-4 my-md-n3 my-xl-n2" src="img/Small-logo.png" alt="Логотип бизнес монетизатор">
        </a>
