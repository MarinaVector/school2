<nav class="nav nav-fill">
    <a class="nav-link" href="../index.php">
        <img class="main-nav__nav-logo mt-md-n2 mr-md-n5 ml-n3 mr-n2" src="img/Logo.png" alt="Логотип онлайн школы">
    </a>
    ...
    <div class="main-nav__nav-links nav-link mt-md-3 mb-md-0 mb-4 ml-n5">
        <div class="d-inline ml-md-0 ml-n5 mr-md-3 mr-2">
            <img class="" src="../img/Whatsapp.png"
                 alt="Sosial-icon">
        </div>
